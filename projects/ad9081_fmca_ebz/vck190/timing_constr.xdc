...
create_clock -name refclk        -period  10.00 [get_ports fpga_refclk_in_p]

# device clock
create_clock -name tx_device_clk  -period 10.00  [get_ports clkin6_p]
create_clock -name rx_device_clk  -period 20.00  [get_ports clkin10_p]
